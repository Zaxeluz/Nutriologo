...
(3, 'Maria Jose', 'Renteria Ayala', '1995-07-06 00:00:00', '2019-04-02 08:16:53', '2019-04-02 08:16:53');
...
(4, 'Maria Jose', 'majo@correo.com', NULL, '$2y$10$V0T5q.bU1RLrOf1Ezwrq3.cbZYckvnJXp4w0qbI0tNf1z9Lb37AXq', NULL, '2019-04-02 08:16:54', '2019-04-02 08:16:54', NULL, 2, 3);
...
--
ALTER TABLE `comidas_dieta`
  ADD CONSTRAINT `comidas_dieta_ibfk_1` FOREIGN KEY (`id_dieta`) REFERENCES `dietas` (`id`),
  ADD CONSTRAINT `comidas_dieta_ibfk_2` FOREIGN KEY (`id_tiempo_alimentacion`) REFERENCES `tiempos_alimentacion` (`id`),
  ADD CONSTRAINT `comidas_dieta_ibfk_3` FOREIGN KEY (`id_dia_semana`) REFERENCES `dias_semana` (`id`);
